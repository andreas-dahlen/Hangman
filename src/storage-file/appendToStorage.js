...
function storeScoreboard() {
  //3. funktionen samlar och lägger informationen i localStorage + max 10 spelare
  let playerResult = {
    //4. objekt med alla resultaten för en enslid spelare
  ...
  //6. push lägger till det nya resultatet längst bak i listan
  ...
  //9. sprara top 10 tillbaka i localStorage under key:'scoreboard'. JSON gör objekten till en sträng så den kan sparas i localStorage
}
